  ...
  return `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
   ...
   <th class="expander"></th>
         ...
         <table>
           <tr>
             <th>
                     <h1 class="text-center">The user ${name} of @ ${email} , has sent an account delete request!</h1>
                     <center data-parsed="">
   ...
   <th class="expander"></th>
                 ...
                 <table class="row"><tbody><tr> <!--This row adds the whitespace gap between masthead and digest content -->
                       <th class="small-12 large-12 columns first last">
         <table>
           <tr>
             <th>
         ...
         <table>
           <tr>
             <th>
               ...
               </td></tr></tbody></table> <!-- / End Email Content -->         
             </center>
           </td>
         </tr>
       </table>
